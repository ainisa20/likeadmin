...
CREATE TABLE `la_decorate_page`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '装修页面配置表';
...
(180, 158, 'C', 'OPC报告管理', 'el-icon-DataAnalysis', 0, 'wizard.wizard_report/lists', 'wizard_report', 'wizard/report/index', '', '', 0, 1, 0, 1774620000, 1774620000),
(181, 180, 'A', '详情', '', 0, 'wizard.wizard_report/detail', '', '', '', '', 0, 1, 0, 1774620000, 1774620000),
(182, 180, 'A', '删除', '', 0, 'wizard.wizard_report/delete', '', '', '', '', 0, 1, 0, 1774620000, 1774620000),
(183, 180, 'A', '更新状态', '', 0, 'wizard.wizard_report/updateStatus', '', '', '', '', 0, 1, 0, 1774620000, 1774620000),
(184, 180, 'A', '备注', '', 0, 'wizard.wizard_report/updateRemark', '', '', '', '', 0, 1, 0, 1774620000, 1774620000);
COMMIT;
